...
m3<-lme(sqrt(general)~Rewet*Fut2,random=~1|plot, data=subset(data_stat, Rewet=="rewet" |Rewet=="not"))
m3<-lme((gram.pos)~Drought*Future,random=~1|plot, data=subset(data_stat, Time=="Recovery"))
...
all
ggsave(plot=all,"Fig. S8.png", width = 8, height = 8)
